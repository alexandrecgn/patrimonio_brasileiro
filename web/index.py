...
base_imaterial = "bens/imaterial.geojson"
base_tombados = "bens/tombados.geojson"
base_valorados = "bens/valorados.geojson"
...
with st.form("pesquisa"):
    ...
    area = st.file_uploader("Selecionar área", type=["gpkg", "shp", "geojson", "kmz", "kml"])
